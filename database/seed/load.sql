...
\copy checkins (name, time, tier, day_of_week, text, challenge_week_id, id, challenger, tz) FROM '/seed/base/checkins.csv' WITH (FORMAT csv, HEADER true);
...
\copy checkins (name, time, tier, day_of_week, text, challenge_week_id, id, challenger, tz) FROM '/seed/current/checkins.csv' WITH (FORMAT csv, HEADER true);
